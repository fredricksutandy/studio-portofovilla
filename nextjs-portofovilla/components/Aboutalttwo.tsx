...
const AboutSection = () => {
  ...
  return (
    <section className="w-full bg-lightbg" id="about">
      <div className="max-w-[1296px] pt-20 md:pt-[120px] mx-auto mb-10 md:mb-12 px-6">

        <div className="flex flex-col flex-1 mb-4 md:mb-14">
          <div className="flex flex-row items-end gap-2 mb-4">
            <Image src={aboutico} alt="Asterisk icon" width={36} height={36} className=""/>
            <h2 className="font-krona text-base text-primary font-medium leading-[100%!important]">{aboutData.title}</h2>
          </div>
          <h3 className="font-montserrat leading-relaxed text-3xl sm:text-4xl font-semibold text-neutral-800 w-full max-w-[]">{aboutData.subtitle}</h3>
        </div>

        <p className="text-base leading-relaxed text-neutral-600 flex flex-1 w-full md:w-7/12 ms-auto">{aboutData.aboutDescription}</p>
      </div>
