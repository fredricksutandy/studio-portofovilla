...
const AboutSection = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-between max-w-[1440px] mx-auto bg-[#Fff] px-4 py-10 md:py-[80px] gap-4">
      <div className="flex flex-col gap-4 md:gap-8 justify-end mb-6 md:mb-0">
        <Image src={aboutico} alt="Asterisk icon" width={120} height={100}/>
        {/* <h1 className="text-lg font-medium  px-6 py-4 bg-[#D6F6E3] text-[#047C36] w-fit rounded">{aboutData.tagTitle}</h1> */}
        <h2 className="text-2xl md:text-3xl mt-4 text-black max-w-[380px] font-semibold">{aboutData.subtitleone}</h2>
        <h2 className="text-2xl md:text-3xl mt-4 text-black max-w-[420px] font-semibold">{aboutData.subtitletwo}</h2>
