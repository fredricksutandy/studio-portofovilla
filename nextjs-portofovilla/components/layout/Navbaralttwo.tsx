...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[1296px] mx-auto flex gap-8 items-center justify-between p-4">
      <Link href="/">
        ...
        {/* Desktop Menu */}
        <ul className="hidden lg:flex flex-1 gap-6">
        <li>
            <Link href="#room">
        ...
        <Link href={contactData.whatsappURL} className={`hidden lg:flex font-semibold gap-2 p-3 ${ isScrolled ? `bg-[#047C36] text-white` : `bg-white text-black` } text-[14px] rounded items-center`}>
        ...
        >
          ...
          <Link href={contactData.whatsappURL} className={`w-full flex font-semibold gap-2 p-4 text-center justify-center bg-[#047C36] text-white text-[14px] rounded items-center`}>
              <Image src={WaLogo} alt='WAlogo' width={20} height={20}/>
              Hubungi kami
            </Link>
        </div>
